...
constexpr std::uint64_t kRngStreamTraitPaths = 7000;  // the path each trait with paths takes this match (Selini)
constexpr std::uint64_t kRngStreamTraitBase = 8000;   // + round number: module and prototype offers
