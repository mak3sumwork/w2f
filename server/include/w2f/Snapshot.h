...
constexpr std::uint32_t kSnapshotVersion = 7;   // 7: a trait choice's bonus items (Najmi cash-outs, demo 1.1); 6: trait system v2 (trait progress, trait choices, takedowns); 5: a player's shop lock; 4: combat events carry the presentation fields (windup, flight, kind, shape, size)
