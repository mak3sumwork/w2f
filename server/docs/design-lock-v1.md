...
* **Round 1 (the opening)**: no shop; every player is dealt one random 1-cost unit (free, onto the bench). The shop is closed **only** in round 1 and in Mother Nature's rounds; it is open in every other round, in **Planning, Combat and Resolution**.
...
* **While units fight** (Combat and Resolution) the shop stays open and a bought champion goes to the bench and may only merge with bench units; selling, moving and equipping are allowed for **bench** units only. The board is locked.
* **Mother Nature** (replaces the carousel and augments): every 3rd round, 2 free gifts of the tier for the stage (early 1-2, mid 3-4, late 5+); the unit gift scales with the stage (1 / 1-2 / 3-4 / 5 cost). The shop is closed for the whole round.
