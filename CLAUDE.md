...
* Open design questions live in `server/docs/content-notes.md` (Helios burn stacking strength, Coregons Emblem stats, Assassin Emblem with no Assassin trait, Lum's active).
